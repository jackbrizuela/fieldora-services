...
export type StorageHash =
  StorageHashBase<'538f0f069e09bcb1858c0d7feb127b309f4884ddd1428f3e7669ef98cb536de4'>;
export type ExecutionHash =
  ExecutionHashBase<'e3f2a93aa0c84deed21cdb1d5e7e9d0b64d565b32151a92e5015d2a46eb9f14d'>;
...
export namespace Models {
  export type public_Lead = {
    ...
    quotes: public_Quote[];
    readonly [RelationKeys]?: 'booking' | 'customer' | 'quotes';
  };
  export type public_Customer = {
    id: CodecTypes['pg/int4@1']['output'];
    customerCode: CodecTypes['pg/text@1']['output'];
    name: CodecTypes['pg/text@1']['output'];
    email: CodecTypes['pg/text@1']['output'] | null;
    phone: CodecTypes['pg/text@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly quote: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['quoteCode'] }];
              indexes: readonly [
                {
                  readonly name: 'quote_leadId_idx_9113844c';
                  readonly prefix: 'quote_leadId_idx';
                  readonly columns: readonly ['leadId'];
                  readonly unique: false;
                },
              ];
